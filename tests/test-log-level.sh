...
main() {
  ...
  test_log_level_param_precedence "checkstyle-google" "info" "debug" "false"
  test_log_level_param_precedence "checkstyle-google" "debug" "info" "true"
  test_log_level_env_var "checkstyle-google" "debug" "true"
  test_log_level_env_var "checkstyle-google" "info" "false"
